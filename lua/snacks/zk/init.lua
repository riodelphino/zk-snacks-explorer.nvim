...
-- Based on explorer (lua/snacks/picker/)
-- M = vim.tbl_deep_extend("force", explorer, M) -- DEBUG:
-- マージでは足りなかった。各関数内部の修正が必要なので、コピペする

-- Copied from `lua/snacks/explorer/init.lua` (Modified for zk)
