...
---@param sort_base boolean?
function M.get_sort_string(entry, sort_base)
  ...
  if sort_base then
    sort_str = string.format("%s[%s%s]", parent_sort, kind, priority) -- e.g. parent[F0], parent[F1], parent[D1]
  else
